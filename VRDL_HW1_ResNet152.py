...
def main():
    ...
    print("Loading ResNet152 pre-trained model...")
    ...
    for epoch in range(EPOCHS):
        ...
        if val_acc > best_val_acc:
            ...
            print(f"Higher validation accuracy detected ({best_val_acc:.2f}%), model saved")
    ...
    print(f"Prediction complete: {best_val_acc:.2f}%. Result saved to {csv_filename}。")
